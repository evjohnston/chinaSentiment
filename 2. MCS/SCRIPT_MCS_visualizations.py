...
summary_file = os.path.join(folder, "china_sentiment_coref_summary.csv")
detailed_file = os.path.join(folder, "china_sentences_coref_detailed.csv")
...
polarity = df_sentences["sentiment"].apply(
    lambda x: "positive" if x > 0.1 else "negative" if x < -0.1 else "neutral"
)
df_sentences["polarity"] = polarity
plt.figure(figsize=(14, 6))
